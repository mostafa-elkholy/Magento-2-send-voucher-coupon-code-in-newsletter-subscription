<?php
/**
 * MaximizeStudio, Mostafa Elkholy Co., Ltd.
 *
 * NOTICE OF LICENSE
 *
 ...
 *
 * @category    Maxmize
 * @package     Maxmize_Newsletter
 * @copyright   Copyright (c) 2003-2019 MaxmizeStudio Co., Ltd. All rights reserved. (https://maxmizestudio.com/), Mostafa Elkholy
 * @license     https://maxmizestudio.com/
 */

namespace Maxmize\Newsletter\Model;
...
class Subscriber extends \Magento\Newsletter\Model\Subscriber
{
    ...
    protected function generateCouponCode()
    {
        try {
            ...
            $couponData['simple_action'] = 'by_percent'; // by_percent, by_fixed, cart_fixed, buy_x_get_y
            ...
            $couponData['customer_group_ids'] = '1';//$this->getCustomerGroupIds();
